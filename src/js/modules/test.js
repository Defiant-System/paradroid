...
let Test = {
	init(APP) {
		...
		setTimeout(() => APP.transfer.els.cbLeft.find(`.toggler div:nth-child(9)`).trigger("click"), 150);
		setTimeout(() => APP.transfer.els.cbRight.find(`.toggler div:nth-child(9)`).trigger("click"), 100);
		return;
